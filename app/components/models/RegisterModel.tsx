  ...
  const footerContent = (
    <div className="flex flex-col gap-4">
      ...
      {/* {
        ...
        <span className="text-neutral-500">Or register with Clerk:</span>
        <div className="mt-2 flex justify-center">
          <SignUpButton mode="modal">
            <button onClick={()=>openSign({modal:"register"})} className="px-4 py-2 border border-black bg-red-500 rounded hover:bg-neutral-200 dark:hover:bg-neutral-800 transition">
              Sign Up with Clerk
            </button>
          </SignUpButton>
        </div>
